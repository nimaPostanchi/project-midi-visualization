...
/*
    This class will come in handy when drawing your music.
*/
...
{
public:
    Bitmap(unsigned width, unsigned height, std::function<Color(const Position2D&)> initializer);
    ...
    Bitmap slice(int x, int y, int width, int height) const;
